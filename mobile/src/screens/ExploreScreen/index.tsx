...
import { SafeView, SearchFilterBar, ShimmerCategoryItem, ShimmerProductCard, ShimmerBrandItem, CachedImage } from '../../components';
    ...
    >
      <View style={styles.topProductImageContainer}>
        ...
        <TouchableOpacity style={styles.topProductCartButton}>
          <Image source={icons.heart} style={styles.topProductCartIcon} />
        </TouchableOpacity>
      </View>
          ...
          {productsLoading ? (
            <View style={styles.horizontalList}>
              <FlatList
                ...
                style={styles.topProductsListStyle}
              />
            </View>
